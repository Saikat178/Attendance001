...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_attendance_employee_date ON attendance_records(employee_id, date);
...
CREATE TRIGGER audit_comp_off_requests
    ...
    FOR EACH ROW EXECUTE FUNCTION audit_comp_off_requests();
