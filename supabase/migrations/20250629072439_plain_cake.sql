/*
  # Corporate Indian Holidays Migration

  1. New Holidays Added
    - Essential national holidays (Republic Day, Independence Day, Gandhi Jayanti)
    - Major religious festivals observed by most companies (Diwali, Holi, Eid, Christmas)
    - Key regional festivals commonly given as holidays in corporate India
    - Important cultural observances (Teachers' Day, etc.)

  2. Holiday Categories
    - National: Government mandated holidays
    - Religious: Major festivals across religions
    - Cultural: Important cultural observances
    - Corporate: Modern workplace observances

  3. Focus
    - Only holidays typically observed by Indian corporations
    - Balanced representation across religions and regions
    - Practical for business calendar planning
*/
...
DECLARE
    ...
    mandatory_holidays INTEGER;
    optional_holidays INTEGER;
BEGIN
    ...
    SELECT COUNT(*) INTO mandatory_holidays FROM holidays WHERE is_optional = false AND EXTRACT(YEAR FROM date::date) = 2025;
    SELECT COUNT(*) INTO optional_holidays FROM holidays WHERE is_optional = true AND EXTRACT(YEAR FROM date::date) = 2025;
    
    -- Report statistics
    RAISE NOTICE '=================================================';
    RAISE NOTICE 'CORPORATE INDIAN HOLIDAYS CONFIGURED!';
    RAISE NOTICE '=================================================';
    ...
    RAISE NOTICE '• Company Observances: %', company_holidays;
    RAISE NOTICE '• 2025 Holidays: %', current_year_holidays;
    RAISE NOTICE '• Mandatory (2025): %', mandatory_holidays;
    RAISE NOTICE '• Optional (2025): %', optional_holidays;
    RAISE NOTICE '=================================================';
    RAISE NOTICE 'Corporate Holiday Categories:';
    RAISE NOTICE '✓ National holidays (Republic Day, Independence Day, Gandhi Jayanti)';
    RAISE NOTICE '✓ Major religious festivals (Diwali, Holi, Eid, Christmas)';
    RAISE NOTICE '✓ Key regional festivals (Durga Puja, Onam, Pongal)';
    RAISE NOTICE '✓ Cultural observances (Teachers Day, Women''s Day)';
    RAISE NOTICE '✓ Modern workplace days (Environment Day, Yoga Day)';
    RAISE NOTICE '=================================================';
    RAISE NOTICE 'Business Functions Available:';
    RAISE NOTICE '• get_holidays_by_year(year) - Annual holiday planning';
    RAISE NOTICE '• get_upcoming_holidays(days) - Short-term planning';
    RAISE NOTICE '• is_working_day(date) - Working day validation';
    RAISE NOTICE '• get_month_calendar(year, month) - Monthly planning';
    RAISE NOTICE '• current_year_holidays view - Quick reference';
    RAISE NOTICE '=================================================';
    RAISE NOTICE 'Perfect for Indian corporate environments!';
    RAISE NOTICE 'Balanced coverage without overwhelming options.';
    RAISE NOTICE '=================================================';
END $$;